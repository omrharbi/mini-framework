...
function App() {
    ...
    return Didact.createElement('div', { class: 'todo-container' },
        // Didact.createElement('button', { class: 'add-button' },
        ...
        //     )
        // ),
        Didact.createElement('div', {class:'todo-header'},
        ...
        Didact.createElement('div', { class: 'tab-container' },
            Didact.createElement('button', { class: 'tab' }, 'Active'),
            Didact.createElement('button', { class: 'tab' }, 'Completed'),
            Didact.createElement('button', { class: 'tab' }, 'All todos')
        ),

        TodoList(filteredTodos),
         
        Didact.createElement('div', { class: 'todo-item' },
                Didact.createElement('div', { class: 'todo-checkbox' }),
                Didact.createElement('div', { class: 'todo-text' }, 'Be happy'),
                Didact.createElement('button', { class: 'delete-button' }, '×')
        )
        )

        // Didact.createElement('button', { class: 'trash-button' },
...
return Didact.createElement('div', { class: 'todo-list' },
    ...todos.map(todo => 
        Didact.createElement('div', { class: `todo-item ${todo.completed ? 'completed' : ''}` },
        Didact.createElement('div', { class: `todo-checkbox ${todo.completed ? 'checked' : ''}` }),
        Didact.createElement('div', { class: 'todo-text', style: `${todo.completed ? 'text-decoration: line-through;' : '' }` }, todo.text),
